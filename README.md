...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/knx-2)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/knx-2
```

A live public deployment of this template is available at [https://knx-2.templates.workers.dev](https://knx-2.templates.workers.dev)
